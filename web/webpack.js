...
const babelLoader = {
  test: /\.js$/,
  include: [/app/, /node_modules\/react-native-/, /node_modules\/react-router/],
...
module.exports = {
  entry: ['babel-polyfill', abspath('../index.web.js')],
  devtool: dev ? 'eval' : false,
  module: {
    rules: [babelLoader, imageLoader, cssLoader, fontLoader, soundLoader],
  },
  output: {
    filename: 'bundle.js',
