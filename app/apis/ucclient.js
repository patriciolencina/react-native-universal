...
(function(root, factory) {
  ...
  ChatClient.prototype = {
    ...
    searchTopicsByCondition: function(condition, funcOK, funcError) {
      ...
      // check condition
      var content =
        condition.content && condition.content.length ? condition.content : [];
      var name = condition.name && condition.name.length ? condition.name : [];
      var subject =
        condition.subject && condition.subject.length ? condition.subject : [];
        ...
        if (this._makeCallStatus[sessionBundleId]) {
          if (this._sessionBundleTable[sessionBundleId]) {
            ...
            sessionBundle = {
              ...
              cameraMuted: false,
              autoAnswer: true,
              autoTerminate: !callSession.option.target.conf_id,
